...
const signUp = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (existingUsername)
            throw (0, http_errors_1.default)(409, `Username already take. Please choose different username`);
        const existingEmail = yield user_1.default.findOne({ email: email }).exec();
        if (existingEmail)
            throw (0, http_errors_1.default)(409, `Email already linked to an existing user. Please log in instead`);
...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!username || !password)
            throw (0, http_errors_1.default)(400, 'Paramenter missing');
